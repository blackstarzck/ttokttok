...
import { REPORT_REASONS, fetchReplyPage, type Comment, type CommentCursor, type CommentPage, type ReportReason } from '@/lib/comments';
 ...
 * 않는다. 시트를 닫았다 열어도 이전에 펼쳤던 스레드가 저절로 다시
 * 펼쳐지지 않는 이유는 `expandFor`가 소비형이기 때문이다: 값을 쓰는
